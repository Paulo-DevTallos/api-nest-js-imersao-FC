...
import { DirectionsRequest, DirectionsResponseData, Client as GoogleMapsClient, TravelMode } from '@googlemaps/google-maps-services-js';
...
export class DirectionsService {
    ...
    async getDirections(placeOriginId: string, placeDestinationId: string) {
        ...
        // formatação para usar no frontend
        return {
            ...data,
            request: {
                origin: {
